...
@lombok.Getter
@lombok.Setter
@Schema(name = "ExecBgtPubDtlPoDto", description = "実行予算公共明細発注情報")
public class ExecBgtPubDtlPoDto {

  /** 実行予算公共明細発注ID. */
  @Schema(name = "id", description = "実行予算公共明細発注ID")
  protected Long id;

  /** 実行予算公共明細ID. */
  @Schema(name = "execBgtDid", description = "実行予算公共明細ID")
   ...
   * コンストラクタ.
   *
   * @param id 実行予算公共明細発注ID
   * @param execBgtDid 実行予算公共明細ID
   * @param poNo 注文書No
   * @param poAmt 発注金額
