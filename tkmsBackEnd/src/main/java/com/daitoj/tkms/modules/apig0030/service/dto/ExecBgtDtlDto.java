...
@lombok.Getter
@lombok.Setter
@Schema(name = "ExecBgtDtlDto", description = "実行予算明細情報")
public class ExecBgtDtlDto {

  /** 実行予算明細ID. */
  @Schema(name = "id", description = "実行予算明細ID")
  private Long id;
  ...
  private List<ExecBgtDtlPoDto> execBgtDtlPoList = new ArrayList<>();
}
