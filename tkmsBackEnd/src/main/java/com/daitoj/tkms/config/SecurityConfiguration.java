...
import com.daitoj.tkms.security.*;
    ...
    http.cors(withDefaults())
        ...
        .authorizeHttpRequests(
            authz ->
                // prettier-ignore
                authz
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/v1/login/auth"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/v1/login/notices"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/v1/reset/auth"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.PUT, "/api/v1/passwordUpdate/update"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/v1/cache/**"))
                    .permitAll()
